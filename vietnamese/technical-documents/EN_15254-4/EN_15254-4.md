...
Đầu ra của một quy trình (bao gồm việc áp dụng các quy định có thể hoặc có thể không hàm chứa các quy trình tính toán được đặt ra) dự đoán một kết quả kiểm nghiệm dựa trên một hoặc nhiều kết quả kiểm nghiệm khác cho cùng một tiêu chuẩn, về sự thay đổi của tính chất và/hoặc (những) mục đích sử dụng đầu cuối của một sản phẩm
